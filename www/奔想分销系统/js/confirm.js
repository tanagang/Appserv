...
jQuery.JSLayer={
		Show:function(_title,_content,_sure,_cancel,_closeEvent){
			...
			html+='<p style="line-height:160%;padding:10px 0;text-align:center;font-size:14px;color:#F4528A">'+_content+'</p>';
			html+=' </div>';
			...
			html+='#confirm{width:240px; min-height:120px; border-radius:2px;padding:3px; border:1px solid rgba(160,160,160,0.1);position:absolute;left:50%;top:30%!important;margin-left:-120px;display:none; padding-bottom:15px;z-index:9999; background:#fff; box-shadow:2px 2px 10px #000; font-family:微软雅黑,Arial, Helvetica, sans-serif}';
			...
			html+='.btn-opa{text-align:center;width:100%;}';
			html+='.btn-opa input{border:none; padding:5px 15px;color:#fff;border-radius:3px}';
			html+='#cancel{background:#F28B5D;color:#fff}';
			html+='#sure{background:#F76358;color:#fff}';
